...
<div class="row">
     ...
     <div class="row">
        ...
        <div class="col-md-5" align="center">
                ...
                <thead style="display: block;">
                 ...
                 <tbody style="display: block; width:auto; height: 200px; overflow-x: auto;">  
                    <tr ng-repeat="row in listpagos">
                      ...
                      <td>@{{row.tipo}}</td>
                      <td>S/.@{{row.monto}}</td>
                     <td><button ng-disabled="otherPhead.saldo==0" type="button" class="btn btn-danger btn-xs"  ng-click="destroyPagos(row)">
            ...
            <div >
                    <button ng-disabled="otherPhead.saldo==0" class=" label-default" type='submit' ng-click='createPagos()' >Registrar Pago</button>  
                   ...
                   <div class="box-footer">
                    <a href="/otherPheads" class="btn btn-danger bnt-xs">Salir</a>
                  </div>
                </form>
              </div><!-- /.box -->
